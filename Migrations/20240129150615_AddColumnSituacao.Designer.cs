...
namespace SistemaBancarioWebAPI.Migrations
{
    ...
    [Migration("20240129150615_AddColumnSituacao")]
    partial class AddColumnSituacao
    {
            ...
            modelBuilder.Entity("SistemaBancarioWebAPI.Models.TransacaoModel", b =>
                {
                    ...
                    b.Property<int?>("ContaCorrenteModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContaCorrenteModelId");
            ...
            modelBuilder.Entity("SistemaBancarioWebAPI.Models.TransacaoModel", b =>
                {
                    ...
                    b.HasOne("SistemaBancarioWebAPI.Models.ContaCorrenteModel", null)
                        .WithMany("Transacoes")
                        .HasForeignKey("ContaCorrenteModelId");
